...
const filterBtnContiner = document.querySelector(".protfolio-filter");
let portfolioItems;
filterBtnContiner.addEventListener("click", (e) =>{
    if(e.target.classList.contains("protfolio-filter-btn") &&
    !e.target.classList.contains("active")){
        filterBtnContiner.querySelector(".active").classList.remove("active");
...
function filterItems(filterBtn){
    ...
    document.querySelectorAll(".portfolio-item").forEach((item) =>{
        const category = item.getAttribute("date-category").split(",");
...
// Filter Active Category Protfolio Items
filterItems(document.querySelector(".protfolio-filter-btn.active"));

/* ------------------ Protfolio Items Details Popup ------------------- */
...
function portfolioItemDetails(){
    ...
    portfolioItems[portfolioItemIndex].querySelector(".protofolio-item-title").innerHTML;

    document.querySelector(".pp-body"). innerHTML = 
    portfolioItems[portfolioItemIndex].querySelector(".portfolio-item-details").innerHTML;     

    document.querySelector(".pp-counter").innerHTML = `${portfolioItemIndex+1} of ${portfolioItems.length} (<span title="category>${document.querySelector(".protfolio-filter-btn.active").innerHTML}</span>)`;
